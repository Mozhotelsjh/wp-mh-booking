...
class OW_Workflow_Settings {
   ...
   /**
    * @var string review process setting option name
    */
   protected $ow_review_process_setting_option_name = 'oasiswf_review_process_setting';
   ...
   public function init_settings() {
      ...
      register_setting( $this->ow_workflow_group_name,
              $this->ow_review_process_setting_option_name,
              array( $this, 'validate_review_process_setting' ) );
...
TRIGGER_EVENT;
                  ...
                  <div class="select-info">
                      <div class="list-section-heading">
                          <label>
                              <?php echo __( "Set your review setting to dictate how and when item moves to the success step:", "oasisworkflow" )
                              ?>
                          </label>
                      </div>
                      <label for="everyone" class="full-width">
                          <input type="radio" id="everyone"
                                 name="<?php echo $this->ow_review_process_setting_option_name; ?>"
                                 value="everyone" 
                                 <?php checked( $review_process_setting, 'everyone' ); ?> />
                      ...
                      <label for="more_than_50" class="full-width">
                          <input type="radio" id="more_than_50"
                                 name="<?php echo $this->ow_review_process_setting_option_name; ?>"
                                 value="more_than_50"
                                 <?php checked( $review_process_setting, 'more_than_50' ); ?>/>
                      ...
                      <label for="anyone" class="full-width">
                          <input type="radio" id="anyone"
                                 name="<?php echo $this->ow_review_process_setting_option_name; ?>"
                                 value="anyone"
                                 <?php checked( $review_process_setting, 'anyone' ); ?> />
                           <?php _e( 'Anyone should approve', 'oasisworkflow' ); ?>
                      </label>
                      <br>
                  </div>

                  <div class="select-info setting-top">
                      <label class="settings-title">

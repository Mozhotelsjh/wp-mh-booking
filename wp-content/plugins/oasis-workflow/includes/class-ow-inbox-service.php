...
class OW_Inbox_Service {
	...
	public function __construct() {
      ...
      add_action( 'wp_ajax_get_workflow_diagram', array( $this, 'get_workflow_diagram' ) );
	}
	...
	public function get_table_header() {
		...
		echo "<th>" . __( "Workflow [Step]", "oasisworkflow" ) . "</th>";
		echo "<th>" . __( "Category", "oasisworkflow" ) . "</th>";
	...
	/**
	 * get the inline edit data - ajax function

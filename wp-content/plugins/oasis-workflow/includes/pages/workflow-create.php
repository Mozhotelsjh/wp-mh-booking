...
<script type="text/javascript">
   var wf_structure_data = '<?php echo $workflow_info; ?>';
   var wfeditable = '<?php echo $wf_editable; ?>';
</script>
    ...
    <form id="wf-form" method="post" action="<?php echo admin_url( 'admin.php?page=oasiswf-admin' ); ?>" >
        <div>
            ...
            <span class="description">
                <?php add_thickbox(); ?>
                <?php _e( 'If you want to know more about creating/modifying workflows ', "oasisworkflow" ); ?>
                <!-- TODO: if this looks great then lets delete the code from js part .help-popup -->
                <a href="<?php echo esc_url( 'http://www.youtube.com/embed/PKHJN_X--Vs?TB_iframe=true&width=800&height=600' ); ?>" class="thickbox">
                    <?php _e( 'watch this video.', "oasisworkflow" ); ?>
                </a>
                <?php _e( ' You can also look up for more tutorial videos about Oasis Workflow on YouTube.', 'oasisworkflow' ); ?>
            </span>
            <br class="clear" />
        </div>
        <div class="fc_action">
...
<ul id="connectionMenu" class="contextMenu">
    ...
    <li class="edit" id="connEdit" >
        <a href="#edit"><?php echo __( "Edit", "oasisworkflow" ) ?></a>
    </li>
    <li class="delete" id="connDelete">
        <a href="#delete"><?php echo __( "Delete", "oasisworkflow" ) ?></a>
    </li>
    <li class="quit separator" id="connQuit">
        <a href="#quit"><?php echo __( "Quit", "oasisworkflow" ) ?></a>
    </li>
</ul>
...
<ul id="stepMenu" class="contextMenu">
    ...
    <li class="edit" id="stepEdit">
        <a><?php echo __( "Edit", "oasisworkflow" ) ?></a>
    </li>
    <?php if( $wf_editable ): ?>
       <li class="copy" id="stepCopy">
           <a href="#copy"><?php echo __( "Copy" ) ?></a>
       </li>
       <li class="delete" id="stepDelete">
           <a href="#delete"><?php echo __( "Delete", "oasisworkflow" ) ?></a>
       </li>
    <?php endif; ?>
    <li class="quit separator" id="stepQuit">
        <a href="#quit"><?php echo __( "Quit", "oasisworkflow" ) ?></a>
    </li>
</ul>
...
<?php if( $wf_editable ): ?>
   <ul id="pasteMenu" class="contextMenu">
       <li class="paste" id="stepPaste">
           <a href="#paste"><?php echo __( "Paste" ) ?></a>
       </li>
       <li class="quit separator" id="stepQuit">
           <a href="#quit"><?php echo __( "Quit" ) ?></a>
       </li>
   </ul>
<?php endif; ?>
<span class="paste_loading">&nbsp;&nbsp;&nbsp;</span>

<!-- step info contents goes here -->

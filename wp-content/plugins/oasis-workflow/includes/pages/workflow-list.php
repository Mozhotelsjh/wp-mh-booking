...
if( $workflows ) {
   $post_counts = $workflow_service->get_post_count_in_workflow();
   foreach ( $workflows as $workflow ) {
      $workflow_id = $workflow->ID;
      if( array_key_exists( $workflow_id, $post_counts ) ) {
         $workflow->post_count = $post_counts[$workflow_id]->post_count;
      }
   }
}

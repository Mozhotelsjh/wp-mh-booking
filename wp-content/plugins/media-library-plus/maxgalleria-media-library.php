...
class MaxGalleriaMediaLib {
  ...
  public function __construct() {
	...
	public function set_global_constants() {	
		...
		define('MAXGALLERIA_MEDIA_LIBRARY_VERSION_NUM', '3.0.9');
...
<!--          <div class="mgmlp-title" id='mg-prono-top'>
        ...
        <!--<p id='mlp-more-info'><a href='http://maxgalleria.com/media-library-plus/' target="_blank"><?php _e('Click here to learn about the Media Library Plus', 'maxgalleria-media-library' ); ?></a></p>-->
					...
					<?php 
						...
						if($phpversion < '5.6')		
							echo "<div>Current PHP version, $phpversion, is outdated. Please upgrade to version 5.6.</div>";
...
order by folder_id";
					...
					if($rows) {
						foreach($rows as $row) {
							...
							$a_attr  = array();
							$a_attr['href'] = home_url() . "/wp-admin/admin.php?page=media-library&media-folder=" . $row->ID;
							$a_attr['target'] = '_self';
